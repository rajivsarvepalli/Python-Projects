...
if __name__ == "__main__":
    data = np.load('C:/Users/Rajiv Sarvepalli/Projects/Data for GMU/tests/hmm_data/hmm_values_of_100_per_file.npy')
    l = np.load('C:/Users/Rajiv Sarvepalli/Projects/Data for GMU/tests/hmm_data/hmm_labels_of_100_per_file.npy')
    print(len(data))
    data = np.array(data)
    ada = ADASYN(ratio= .7,imb_threshold=.7 ,k=10)
    data,l = ada.fit_transform(data,l) 
